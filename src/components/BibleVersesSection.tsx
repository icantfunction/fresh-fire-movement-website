    ...
    <section className="py-20 px-4 royal-gradient">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="space-y-8">
          <Card className="p-8 bg-white/10 backdrop-blur-md border border-white/20 text-center animate-gentle-float">
          ...
          <Card className="p-8 bg-white/10 backdrop-blur-md border border-white/20 text-center animate-dance-sway">
            <blockquote className="text-xl md:text-2xl text-white italic mb-4">
